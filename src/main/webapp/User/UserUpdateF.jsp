...
<table border="1" cellspacing="0" cellpadding="0" align="center" width="100%">
		...
		<tr height="40">
			...
			<td width="80">
				<input type="text" name="birth"value="<%=ezu1.getBirth() %>" size="20" placeholder="8자리 숫자만 입력해주세요 ex.19940303" onkeypress="CheckKey()" onchange="checkLogin()" required readonly="readonly" style="background-color: #ECEBE3"/>  
			</td>				
		</tr>
