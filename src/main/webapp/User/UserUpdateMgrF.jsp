	...
	<div align="center" >
		<table border = "1" align="center" style="width:600;" >
			...
			<tr height="40" align="center">
				...
				<td width="350">	
					<input type="text" style="text-align:center; background-color: #ECEBE3;" maxlength = "8" name="birth"value="<%=ezu1.getBirth() %>" pattern="(19|20)\d{2}(0[1-9]|1[012])(0[1-9]|[12][0-9]|3[01])" size="20" onkeypress="CheckNumPress()"  required readonly="readonly" />  
				</td>		
			</tr>
